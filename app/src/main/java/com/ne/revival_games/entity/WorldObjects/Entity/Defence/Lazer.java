...
public class Lazer extends Projectile {
    ...
    public Lazer(double width, double direction, double speed, double health,
                 MyWorld world, boolean addToWorld) {
        super(addToWorld, direction, speed, (int) health, world);
        this.world = world;
