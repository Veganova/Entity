...
public class DoubleScreen extends ViewGroup {
    ...
    public DoubleScreen(Context context) {
        super(context);
    }

    public DoubleScreen(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DoubleScreen(Context context, AttributeSet attrs, int defStyle) {
...
//        maxWidth = Math.max(maxWidth, getSuggestedMinimumWidth());
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new DoubleScreen.LayoutParams(getContext(), attrs);
    }
